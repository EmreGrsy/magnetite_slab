...
fig, axs = plt.subplots(1, 2, figsize=(15*0.2857, 6), facecolor="w", 
...
axs[0].plot(df_list[7]["rfe3"], df_list[7]["layer"], linewidth=4, label="17", color="blue")
axs[1].plot(df_list[8]["rfe3"], df_list[8]["layer"], linewidth=4, label="21", color="blue")

axs[0].set_title("13L", fontsize=24, pad=15)
axs[1].set_title("17L", fontsize=24, pad=15)
...
fig.savefig('fe3_oct_ratio_SCV.pdf',format='pdf', bbox_inches = "tight")
fig.savefig('fe3_oct_ratio_SCV.png', dpi=300.0,format='png', bbox_inches = "tight")
